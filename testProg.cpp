...
{                                    // Line 6
    ...
    // Line 8]
    arrayListType<Animal*> animals(30);


    animals.insertEnd(new Dog("Buddy"));
    animals.insertEnd(new Cat("Whiskers"));

    for (int i = 0; i < animals.listSize(); ++i)
    {
